...
if env["PIOENV"].endswith("_ota"):
    # Generated by Copilot: On this macOS setup, PlatformIO/Homebrew Python
    # raises Errno 65 for UDP sendto to LAN clients during espota handshake.
    # System Python works reliably for this OTA step.
    system_python = Path("/usr/bin/python3")
    if system_python.exists():
        env.Replace(PYTHONEXE=str(system_python))
