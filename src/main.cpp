...
namespace
{
  ...
  void handleRoot()
  {
    ...
    html += F("<section class='card'><h2>Firmware Update</h2><p>If PlatformIO OTA fails, upload firmware in the browser.</p><p><a href='/update'>Open Web Updater</a></p><small>Use .pio/build/ifan04_ota/firmware.bin</small></section>");
